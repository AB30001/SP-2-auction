...
function setPostNew() {
  ...
  submitNew.className = "btn w-100 btn-lg my-2 mb-5";
  submitNew.style.backgroundColor = "#743B72";
  submitNew.style.color = "white";
...
function setPostEdit(jsonReturn) {
  ...
  submitEdit.className = "btn w-100 btn-lg my-2 mb-5";
  submitEdit.style.backgroundColor = "#743B72";
...
function placeBid(token, cardBody, id) {
  if (token != null || token != "") {
    ...
    submitBid.className = "btn my-2 mb-5";
    submitBid.style.backgroundColor = "#743B72";
    submitBid.style.color = "white";
