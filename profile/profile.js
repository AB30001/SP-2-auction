...
function enableCreateListingAndUpdateAvatar(username) {
  if (username === localStorage.getItem("username")) {
    addListingButton.className = "btn col-4";
    addListingButton.style.backgroundColor = "#743B72";
    addListingButton.style.color = "white";
    updateAvatarForm.className = "";
    updateAvatarButton.style.backgroundColor = "#743B72";
    updateAvatarButton.style.color = "white";
...
function setProfileListings(jsonReturn) {
  ...
  profileListings.forEach((element) => {
    ...
    readMore.style.backgroundColor = "#743B72";
    ...
    if (username === localStorage.getItem("username")) {
      ...
      edit.className = "btn text-white mx-2";
      edit.style.backgroundColor = "#743B72";
      edit.innerHTML = "Edit";
      cardBody.append(edit);
      const deleteButton = document.createElement("button");
      deleteButton.type = "button";
      deleteButton.className = "btn float-end";
      deleteButton.style.backgroundColor = "#743B72";
